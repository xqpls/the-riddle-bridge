...
function animateWalk(duration, targetX) {
    return new Promise(resolve => {
        ...
        // Set character to standing pose first
...
async function placeBridgeAndMovePlayer(isSuccess) {
    ...
    if (!isSuccess) {
        ...
        if (gameState.currentLight < MAX_LIGHT) {
            showMissPart();
        }
...
function init() {
    ...
    ui.background.style.backgroundImage = "url('assets/images/background.jpg')";
    ui.bridgeBase.style.backgroundImage = "url('assets/images/bridge.png')";
